...
`;
    ...
    const LIB_ORDER = [
      ...
      // Cubism Core 必须用官网最新版（支持 moc3 v5+）；本地打包的旧版（纯 JS 2019）无法解析新版模型，故始终走 CDN
      { file: 'live2dcubismcore.min.js', key: 'Live2DCubismCore', alwaysCdn: true, cdn: 'https://cubism.live2d.com/sdk-web/cubismcore/live2dcubismcore.min.js' },
